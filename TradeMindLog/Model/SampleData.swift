...
struct SampleData {
    static var records: [Record] = [
        ...
        Record(id: UUID(), stockName: "Marubeni", tickerCode: "3333", buyDate: .now.addingTimeInterval(-172800), sellDate: nil, buyPrice: 3000.0, sellPrice: 3200.0, quantity: 400, situation: Situation.buy, buyReasons: [BuyReason.innovationLaunch, BuyReason.others], sellReasons: [SellReason.profitTaking], note: "OK", rating: 4, reflection: "Nice"),
    ]
}
