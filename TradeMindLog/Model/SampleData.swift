...
struct SampleData {
    static var records: [Record] = [
        Record(id: UUID(), stockName: "Toyota", tickerCode: "1111", buyDate: .now.addingTimeInterval(86400), sellDate: nil, buyPrice: 1000.0, sellPrice: 1200.0, quantity: 200, situation: Situation.buy, buyReasons: [BuyReason.highProfitMargin, BuyReason.emotionalDecision], sellReasons: [SellReason.profitTaking], note: "Good choice", rating: 3, reflection: "So-so choice"),
        ...
        Record(id: UUID(), stockName: "Marubeni", tickerCode: "3333", buyDate: nil, sellDate: .now.addingTimeInterval(172800), buyPrice: 3000.0, sellPrice: 3200.0, quantity: 400, situation: Situation.buy, buyReasons: [BuyReason.innovationLaunch, BuyReason.others], sellReasons: [SellReason.profitTaking], note: "OK", rating: 4, reflection: "Nice"),
    ]
}
